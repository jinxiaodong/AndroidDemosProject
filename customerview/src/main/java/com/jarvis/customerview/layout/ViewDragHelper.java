...
package com.jarvis.customerview.layout;
...
public class ViewDragHelper {
    ...
    void setDragState(int state) {
        ...
        Log.i(TAG, "setDragState:" + getStateDes(mDragState));
    }

    private String getStateDes(int mDragState) {
        switch (mDragState) {
            case STATE_DRAGGING:
    ...
    boolean tryCaptureViewForDrag(View toCapture, int pointerId) {
        if (toCapture == mCapturedView && mActivePointerId == pointerId) {
            // Already done!
            Log.i(TAG, "tryCaptureViewForDrag()=== toCapture == mCapturedView");
            return true;
        }
        if (toCapture != null && mCallback.tryCaptureView(toCapture, pointerId)) {
            mActivePointerId = pointerId;
            captureChildView(toCapture, pointerId);
            Log.i(TAG, "tryCaptureViewForDrag()===true");

            return true;
        }
        Log.i(TAG, "tryCaptureViewForDrag()===false, toCapture==" + (toCapture == null));
        return false;
    }
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (toCapture == mCapturedView && mDragState == STATE_SETTLING) {
                    Log.i(TAG, "ACTION_DOWN:------tryCaptureViewForDrag()");
            ...
            case MotionEvent.ACTION_POINTER_DOWN: {
                ...
                if (mDragState == STATE_IDLE) {
                    ...
                    if (toCapture == mCapturedView) {
                        Log.i(TAG, "ACTION_POINTER_DOWN:------tryCaptureViewForDrag()");
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    final View toCapture = findTopChildUnder((int) x, (int) y);
                    Log.i(TAG, "ACTION_MOVE:------tryCaptureViewForDrag() toCapture != null " + (toCapture != null));
//                     boolean pastSlop = false;
                    ...
                    Log.i(TAG, "ACTION_MOVE:------tryCaptureViewForDrag() pastSlop = " + pastSlop);
